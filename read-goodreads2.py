...
def webdr():
    ...
    USERNAME = ''
    PASSWORD = ''
    login = driver.find_element_by_xpath("//input[@type='email']").send_keys(USERNAME)
    ...
    booklist = driver.find_element_by_xpath("//a[text()='My Books']").click()
    time.sleep(15)
    pagecount = driver.find_element_by_xpath("//select[@name='per_page']/option[text()='75']").click()
